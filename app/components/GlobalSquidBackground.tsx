...
const GlobalSquidBackground = () => {
  ...
  useEffect(() => {
    ...
    // WebGL Fluid Simulation Configuration
    let config = {
      SIM_RESOLUTION: 128,
      DYE_RESOLUTION: 1024,
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      let aspectRatio = canvas.width / canvas.height;
      pointer.deltaX = aspectRatio < 1 ? (pointer.texcoordX - pointer.prevTexcoordX) * aspectRatio : (pointer.texcoordX - pointer.prevTexcoordX);
      pointer.deltaY = aspectRatio > 1 ? (pointer.texcoordY - pointer.prevTexcoordY) / aspectRatio : (pointer.texcoordY - pointer.prevTexcoordY);
