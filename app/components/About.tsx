    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
          {/* Our Story */}
          <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 border border-white/50 dark:border-gray-700/50 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-[#1a1a1a] dark:text-white mb-4 group-hover:text-[#009bd7] transition-colors duration-300">
                OUR STORY
              </h3>
          ...
          <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 border border-white/50 dark:border-gray-700/50 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-[#1a1a1a] dark:text-white mb-4 group-hover:text-blue-500 transition-colors duration-300">
                OUR MISSION
              </h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 border border-white/50 dark:border-gray-700/50 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-[#1a1a1a] dark:text-white mb-4 group-hover:text-indigo-500 transition-colors duration-300">
                OUR VISION
              </h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
